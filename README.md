...
- [Agent 详细划分](#agent-详细划分)
  - [Agent 1: prospectus_analyzer](#agent-1-prospectus_analyzer--基金文档解析专员)
  - [Agent 2: performance_analyst](#agent-2-performance_analyst--业绩归因分析师)
  - [Agent 3: cost_analyzer](#agent-3-cost_analyzer--费率侦探)
  - [Agent 4: manager_profiler](#agent-4-manager_profiler--基金经理画像师)
  - [Agent 5: macro_strategist](#agent-5-macro_strategist--宏观策略顾问)
  - [Agent 6: wealth_advisor](#agent-6-wealth_advisor--财富顾问综合评级与时机判断)
  - [Agent 7: sector_screener](#agent-7-sector_screener--行业筛选引擎)
  - [Agent 8: fund_comparator](#agent-8-fund_comparator--多基金对比分析师)
  - [Agent 9: portfolio_doctor](#agent-9-portfolio_doctor--组合诊断师)
  - [Agent 10: watchtower](#agent-10-watchtower--监控预警塔)
- [工作流](#工作流)
  - [Workflow A: 单基金深度分析](#workflow-a-单基金深度分析)
  - [Workflow B: 行业/偏好筛选](#workflow-b-行业偏好筛选)
  - [Workflow C: 组合持仓诊断](#workflow-c-组合持仓诊断)
  - [Workflow D: 持续监控预警](#workflow-d-持续监控预警)
- [快速开始](#快速开始)
- [项目结构](#项目结构)
- [许可证](#许可证)
...
FAMAS 是一个面向个人投资者的基金分析决策支持系统，将基金分析任务拆解为 **10个专业化Agent**，覆盖 **"单基金深度分析 -> 多基金对比筛选 -> 组合持仓诊断 -> 持续监控预警"** 的全链路投资决策闭环。
...
### Agent 6: wealth_advisor — 财富顾问（综合评级与时机判断） 🏷️
...
| **关键约束**     | **严禁输出"买入"/"卖出"/"加仓"/"减仓"/"清仓"等明确交易信号 ❗**                                                                         |
...
### Agent 8: fund_comparator — 多基金对比分析师 ⚖️
