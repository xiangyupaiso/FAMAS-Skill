...
![TRAE](https://img.shields.io/badge/TRAE-%20-blue) ![Claude%20Code](https://img.shields.io/badge/Claude%20Code-%20-purple) ![Codex](https://img.shields.io/badge/Codex-%20-orange) ![Skill](https://img[...]
...
- [Agent 详细划分](#agent-详细划分-🔬)
  ...
  - [Agent 6: wealth_advisor](#agent-6-wealth_advisor--财富顾问综合评级与时机判断-🏷️)
  - [Agent 7: sector_screener](#agent-7-sector_screener--行业筛选引擎-🔎)
  - [Agent 8: fund_comparator](#agent-8-fund_comparator--多基金对比分析师-⚖️)
...
FAMAS 是一个面向个人投资者的基金分析决策支持系统，将基金分析任务拆解为 **10个专业化Agent**，覆盖 **"单基金深度分析 -> 多基金对比筛选 -> 组合持仓诊断"** 的完整投资决策闭环。
